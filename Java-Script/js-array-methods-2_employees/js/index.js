...
function findByLastName(employees, lastName) {
  return employees.find(employees => employees.lastName === lastName);
...
function findByCitySubString(employees, string) {
  return employees.find((employees) => employees.city.includes(string));
}
...
function findByProfessionSubStringAndAge(employees, string, age) {
  return employees.find((employees) => employees.profession.includes(string) && employees.age > age);
}
