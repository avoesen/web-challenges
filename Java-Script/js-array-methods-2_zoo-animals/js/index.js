...
function hasAnimal(animals, animalName) {
  ...
  // const foundAnimal = animals.find(animal => animal === animalName)
  const lowerCaseAnimal = animalName.toLowerCase();
  const foundAnimal = animals.find(animal => animal.toLowerCase() === lowerCaseAnimal)
  console.log(foundAnimal)
  return Boolean(foundAnimal);
}
